...
export const SessionDetail: React.FC<SessionDetailProps> = ({ sessionId, onBack }) => {
  ...
  if (loading && (!activeSession || needsReport)) {
    return (
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-6 p-6 overflow-hidden">
          ...
          <div className="flex-1 w-full bg-slate-900/10 border border-slate-900 rounded-2xl p-6 space-y-5">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="h-4 w-[92%] bg-slate-900 rounded-md" />
              <div className="h-4 w-[95%] bg-slate-900 rounded-md" />
              <div className="h-4 w-[85%] bg-slate-900/80 rounded-md" />
            </div>

            <div className="space-y-3 pt-4">
              <div className="h-4 w-[90%] bg-slate-900 rounded-md" />
              <div className="h-4 w-[96%] bg-slate-900 rounded-md" />
              <div className="h-4 w-[60%] bg-slate-900/70 rounded-md" />
            </div>
          </div>
        </div>
      </div>
